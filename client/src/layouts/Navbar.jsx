    ...
    <div className="relative">
      ...
      >
        ...
        <div className="hidden lg:flex gap-15">
          <div className="flex items-center gap-2 cursor-pointer duration-200 hover:scale-104" onClick={() => navigate("/products")} >
            <img className="w-5 h-5" src={Product} alt="" />
            <p>Products</p>
          </div>
          <div className="flex items-center gap-2 cursor-pointer duration-200 hover:scale-104">
          ...
          <div className="w-full flex gap-5 justify-between items-center">
            <>
              {isLoggedIn ? (
                ...
                >
                  <button
                    className="font-sans text-[16px] py-1.5 cursor-pointer"
